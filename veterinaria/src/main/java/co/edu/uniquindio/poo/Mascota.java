...
public Mascota {
    ...
    assert id != null : "debe llenar este espacio";
    assert nombre != null : "debe llenar este espacio";
    assert especie != null : "debe llenar este espacio";
    assert raza != null: "debe llenar este espacio";
    ...
    assert color != null : "debe llenar este espacio";
